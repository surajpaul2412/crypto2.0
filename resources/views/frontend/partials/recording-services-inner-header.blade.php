<nav class="cc-nav" id="cc-nav" role="navigation" aria-label="{{ __('site.aria_main_nav') }}">
  ...
  <ul class="cc-nav__menu">
    ...
    <li class="cc-nav__item cc-nav__item--social">
      <button class="cc-nav__link cc-nav__link--social" type="button" aria-haspopup="true" aria-expanded="false" aria-controls="cc-nav-social-dropdown" aria-label="{{ __('site.aria_social') }}">
        ...
        <span class="cc-nav__label">{{ __('site.nav_social') }}</span>
      </button>
    ...
    <li class="cc-nav__item cc-nav__item--account">
      <button class="cc-nav__link cc-nav__link--account" type="button" aria-haspopup="true" aria-expanded="false" aria-controls="cc-nav-account-dropdown" aria-label="{{ __('site.aria_account') }}">
        ...
        <span class="cc-nav__label">{{ __('site.nav_login') }}</span>
  ...
  <button class="cc-nav__hamburger" type="button" aria-label="{{ __('site.aria_toggle_nav') }}" aria-controls="cc-nav-mobile" aria-expanded="false">
    <span></span>
    <span></span>
    <span></span>
  </button>
