...
@media (max-width: 1024px) { .wishlist-main { padding: 7rem 1.5rem 4rem; } }
@media (max-width: 560px)  { .wishlist-main { padding: 6.5rem 1.1rem 3rem; } }

.wishlist-head { margin-bottom: 3rem; }
.wishlist-title {
...
.wishlist-empty__icon svg { width: 100%; height: 100%; }
...
.wishlist-empty__cta:hover { transform: translateY(-2px); box-shadow: 0 14px 36px rgba(0,0,0,0.4), 0 0 24px rgba(117,194,73,0.22); }
.wishlist-empty__cta svg { width: 15px; height: 15px; transition: transform 0.3s ease; }
.wishlist-empty__cta:hover svg { transform: translateX(4px); }
