...
/* ─── Reveal pattern · owned by polish.css §3 + polish.js ────── */
.libinner [data-reveal] {
  opacity: 0;
...
/* ═══════════════════════════════════════════════════════════════
   E3 · page-body mix-blend-mode kill (page 09 polish pass)
   Neutralises both body::before declarations (lines ~45 and ~4609 of
   the original draft — same rule declared twice). Footer ::before
   layers untouched (shared component).
   ═══════════════════════════════════════════════════════════════ */
body::before {
...
<script type="application/ld+json">
{
  ...
  "url": "https://cryptocipher.in/terms-of-service",
