  ...
  <div class="mxd-container grid-container">
    ...
    <div class="mxd-block">
      <div class="container-fluid p-0">
        <div class="row g-0">
          <div class="col-12 col-xl-3 mxd-demo-footer__item mxd-grid-item">
            <div class="mxd-demo-footer__logo anim-uni-in-up">
              <a href="#0" class="mxd-logo">
                <!-- logo icon -->
                <svg class="mxd-logo__image" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 56 56" style="enable-background:new 0 0 56 56;" xml:space="preserve">
                  <style type="text/css">
                    ...
                    .mxd-logo__cat{clip-path:url(#mxd-logo__id-2);fill:var(--base);}
                  </style>
                  <path class="mxd-logo__bg" d="M56,28c0,11.1-2.9,28-28,28S0,39.1,0,28S2.9,0,28,0S56,16.9,56,28z"/>
                  <g>
                    <defs>
                      <path id="mxd-logo__clippath-2" d="M28,0C2.9,0,0,16.9,0,28s2.9,28,28,28s28-16.9,28-28S53.1,0,28,0z"/>
                    </defs>
                    <clipPath id="mxd-logo__id-2">
                      <use xlink:href="#mxd-logo__clippath-2"  style="overflow:visible;"/>
                    </clipPath>
            ...
            <div class="mxd-demo-footer__slogan anim-uni-in-up">
              <p class="t-small t-bright">👋 New Rayo template is here! Showcase your projects, services and expertise with impact.</p>
            </div>
            <div class="mxd-demo-footer__btn anim-uni-in-up">
              <a class="btn btn-anim btn-default btn-small btn-accent slide-right" href="https://1.envato.market/kOvmWN" target="_blank">
                <span class="btn-caption">Buy Now</span>
                <i class="ph ph-shopping-cart-simple"></i>
              </a>
              <a class="btn btn-anim btn-default btn-small btn-outline slide-right-up" href="#demo">
                <span class="btn-caption">Demo</span>
                <i class="ph ph-arrow-up-right"></i>
              </a>
            </div>
          </div>
          <div class="col-12 col-xl-6 mxd-demo-footer__item">
            <nav class="mxd-demo-footer__nav">
              <div class="container-fluid p-0">
                <div class="row g-0">
                  <div class="col-12 col-md-4 mxd-grid-item mxd-footer-nav__item">
                    <div class="mxd-footer-nav__block">
                      <div class="mxd-footer-nav__title anim-uni-in-up">
                        <p class="t-140 t-bright t-caption">Start pages</p>
                      </div>
                      <div class="mxd-footer-nav__list">
                        <ul>
                          <li><a class="anim-uni-in-up" href="index-main.html" target="_blank">Main home</a></li>
                          <li><a class="anim-uni-in-up" href="index-software-development-company.html" target="_blank">Software development company</a></li>
                          <li><a class="anim-uni-in-up" href="index-freelancer-portfolio.html" target="_blank">Freelanser portfolio</a></li>
                          <li><a class="anim-uni-in-up" href="index-digital-agency.html" target="_blank">Digital agency</a></li>
                          <li><a class="anim-uni-in-up" href="index-creative-design-studio.html" target="_blank">Creative design studio</a></li>
                          <li><a class="anim-uni-in-up" href="index-personal-portfolio.html" target="_blank">Personal portfolio</a></li>
                          <li><a class="anim-uni-in-up" href="index-web-agency.html" target="_blank">Web agency</a></li>
                          <li><a class="anim-uni-in-up" href="index-creative-developer.html" target="_blank">Creative developer</a></li>
                          <li><a class="anim-uni-in-up" href="index-designer.html" target="_blank">Designer</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-4 mxd-grid-item mxd-footer-nav__item">
                    <div class="mxd-footer-nav__block">
                      <div class="mxd-footer-nav__title anim-uni-in-up">
                        <p class="t-140 t-bright t-caption">Portfolio</p>
                      </div>
                      <div class="mxd-footer-nav__list">
                        <ul>
                          <li><a class="anim-uni-in-up" href="works-simple.html" target="_blank">Works simple</a></li>
                          <li><a class="anim-uni-in-up" href="works-masonry.html" target="_blank">Works masonry</a></li>
                          <li><a class="anim-uni-in-up" href="project-details.html" target="_blank">Project details</a></li>
                        </ul>
                      </div>
                    </div>
                    <div class="mxd-footer-nav__block">
                      <div class="mxd-footer-nav__title anim-uni-in-up">
                        <p class="t-140 t-bright t-caption">Insights pages</p>
                      </div>
                      <div class="mxd-footer-nav__list">
                        <ul>
                          <li><a class="anim-uni-in-up" href="blog-standard.html" target="_blank">Blog standard</a></li>
                          <li><a class="anim-uni-in-up" href="blog-creative.html" target="_blank">Blog creative</a></li>
                          <li><a class="anim-uni-in-up" href="blog-article.html" target="_blank">Single post</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-4 mxd-grid-item mxd-footer-nav__item">
                    <div class="mxd-footer-nav__block">
                      <div class="mxd-footer-nav__title anim-uni-in-up">
                        <p class="t-140 t-bright t-caption">Inner pages</p>
                      </div>
                      <div class="mxd-footer-nav__list">
                        <ul>
                          <li><a class="anim-uni-in-up" href="about-me.html" target="_blank">About me</a></li>
                          <li><a class="anim-uni-in-up" href="about-us.html" target="_blank">About us</a></li>
                          <li><a class="anim-uni-in-up" href="services.html" target="_blank">Services</a></li>
                          <li><a class="anim-uni-in-up" href="team.html" target="_blank">Our team</a></li>
                          <li><a class="anim-uni-in-up" href="pricing.html" target="_blank">Pricing plans</a></li>
                          <li><a class="anim-uni-in-up" href="faq.html" target="_blank">Frequently asked questions</a></li>
                          <li><a class="anim-uni-in-up" href="404.html" target="_blank">404 error page</a></li>
                          <li><a class="anim-uni-in-up" href="contact.html" target="_blank">Contact</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-12 col-xl-3 mxd-demo-footer__item mxd-grid-item">
            <div class="mxd-demo-footer__promo">
              <div class="mxd-footer-promo__title anim-uni-in-up">
                <p class="t-140 t-bright t-caption">More by Mix Design:</p>
              </div>
              <div class="mxd-footer-promo__list">
                <a class="mxd-footer-promo__item" href="https://1.envato.market/rQ5AQD" target="_blank">
                  <img class="mxd-footer-promo__icon anim-uni-in-up" src="img/demo/icon-blayden.webp" alt="Blayden - Personal Portfolio & Resume HTML Template">
                  <span class="mxd-footer-promo__link anim-uni-in-up">Blayden - Personal Portfolio & Resume HTML Template</span>
                </a>
                <a class="mxd-footer-promo__item" href="https://1.envato.market/9gBzn0" target="_blank">
                  <img class="mxd-footer-promo__icon anim-uni-in-up" src="img/demo/icon-ignite.webp" alt="Ignite - Portfolio and Landing Page Template">
                  <span class="mxd-footer-promo__link anim-uni-in-up">Ignite - Portfolio and Landing Page Template</span>
                </a>
                <a class="mxd-footer-promo__item" href="https://1.envato.market/anoYGQ" target="_blank">
                  <img class="mxd-footer-promo__icon anim-uni-in-up" src="img/demo/icon-braxton.webp" alt="Braxton - Personal Portfolio & Resume HTML Template">
                  <span class="mxd-footer-promo__link anim-uni-in-up">Braxton - Personal Portfolio & Resume HTML Template</span>
                </a>
              </div>
            </div>
          </div>
    ...
    <div class="mxd-block">
      <div class="mxd-demo-footer__mixdesign mxd-grid-item no-margin">
        <a class="anim-uni-in-up" href="https://1.envato.market/EKA9WD" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 400 74" fill="currentColor">
