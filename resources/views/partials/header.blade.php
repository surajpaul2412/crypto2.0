      ...
      <div class="mxd-menu__inner">
            ...
            <nav class="main-menu__content">
              <ul id="main-menu" class="main-menu__accordion">
                <li class="main-menu__item">
                  <a class="main-menu__link btn btn-anim" href="{{route('home')}}">
                ...
                <li class="main-menu__item">
                  <a class="main-menu__link btn btn-anim" href="{{route('contact')}}">
                    <span class="btn-caption">Contact</span>
                  </a>
                </li>
                <li class="main-menu__item">
                  <a class="main-menu__link btn btn-anim" href="{{route('login')}}">
                    <span class="btn-caption">My Account</span>
                  </a>
                </li>
              </ul>
            </nav>
        ...
        <div class="mxd-menu__right">
          <div class="menu-promo">
            <div class="menu-promo__content">
              <p class="menu-promo__caption menu-fade-in">👋 New Rayo template is here!<br>Showcase your projects, services and expertise with impact.</p>
        ...
        <div class="mxd-menu__data menu-fade-in">
          <p class="t-xsmall">
            ...
            <a class="no-effect" href="https://cryptocipheracademy.com/" target="_blank">Crypto Cipher Academy</a>
          </p>
          <p class="t-xsmall">
